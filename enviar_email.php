...
<?php
    ...
    $para = "matmarciojsb@trilheirosextremos.com"; //dono do site
    //$copia = "claudio@oi.com.br";
   ...
   <header>
        ...
        <nav>
          <ul>
            ...
            <li><a href="contato.html" style="color:#6B8E23; border-bottom: solid #6b8e23 3px;"> CONTATOS </a></li>
          </ul>
        </nav>
        <div id="log">
